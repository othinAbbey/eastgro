/*
  ...
  - You are about to drop the `_ServiceOfferingToServiceProvider` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "ServiceOffering" DROP CONSTRAINT "ServiceOffering_offeringId_fkey";

-- DropForeignKey
ALTER TABLE "ServiceOffering" DROP CONSTRAINT "ServiceOffering_providerId_fkey";

-- DropForeignKey
ALTER TABLE "ServiceOffering" DROP CONSTRAINT "ServiceOffering_serviceId_fkey";

-- DropForeignKey
ALTER TABLE "_ServiceOfferingToServiceProvider" DROP CONSTRAINT "_ServiceOfferingToServiceProvider_A_fkey";

-- DropForeignKey
ALTER TABLE "_ServiceOfferingToServiceProvider" DROP CONSTRAINT "_ServiceOfferingToServiceProvider_B_fkey";
...
-- DropTable
DROP TABLE "_ServiceOfferingToServiceProvider";
